...
class MainPageWire extends Component{
    ...
    public function render(){
        ...
        $this->mainItems = Posts::where('location', 1)->get();
        $this->subItems = Posts::where('location', 2)->get();*/
    ...
    public function mount(){
        $this->fill([
            'mainItems' => Posts::where('location', 1)->get(),
            'subItems' => Posts::where('location', 2)->get()
        ]);
    }
